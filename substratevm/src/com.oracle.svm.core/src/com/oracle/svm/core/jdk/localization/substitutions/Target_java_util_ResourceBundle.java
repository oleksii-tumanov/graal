...
final class Target_java_util_ResourceBundle {
    ...
    private static ResourceBundle getBundleImpl(String baseName,
        ...
        if (callerModule.isNamed() && loader == getLoader(callerModule)) {
            if (!ImageSingletons.lookup(LocalizationSupport.class).isRegisteredBundleLookup(callerModule, baseName, locale, control)) {
        ...
        if (!ImageSingletons.lookup(LocalizationSupport.class).isRegisteredBundleLookup(unnamedModule, baseName, locale, control)) {
    ...
    private static ResourceBundle getBundleFromModule(Class<?> caller,
        ...
        Module callerModule = getCallerModule(caller);
        if (!ImageSingletons.lookup(LocalizationSupport.class).isRegisteredBundleLookup(module, baseName, locale, control)) {
